...
const seed = async () => {
  ...
  try {
    ...
    const p1 = await Product.create({
      ...
      sku: 'CAF-MOG-250',
      category_id: cat1.id,
      images: ['https://picsum.photos/id/755/600/600'],
      weight_kg: 0.250,
      is_featured: true,
      is_active: true,
    ...
    const p2 = await Product.create({
      ...
      sku: 'CAF-CER-250',
      category_id: cat1.id,
      images: ['https://picsum.photos/id/1060/600/600'],
      weight_kg: 0.250,
      is_featured: true,
      is_active: true,
    ...
    const p6 = await Product.create({
      ...
      sku: 'MOI-MOG-250',
      category_id: cat2.id,
      images: ['https://picsum.photos/id/429/600/600'],
      weight_kg: 0.250,
      is_featured: false,
      is_active: true,
    ...
    const p18 = await Product.create({
      ...
      sku: 'KIT-BAR-INI',
      category_id: cat5.id,
      images: ['https://picsum.photos/id/491/600/600'],
      weight_kg: 0.900,
      is_featured: true,
      is_active: true,
    ...
    await Post.create({
      ...
      cover_image: 'https://picsum.photos/id/102/800/400',
      author_id: admin.id,
    ...
    await Post.create({
      ...
      cover_image: 'https://picsum.photos/id/1060/800/400',
      author_id: admin.id,
    ...
    await Post.create({
      ...
      cover_image: 'https://picsum.photos/id/755/800/400',
      author_id: admin.id,
